...
const semillasRegulares = [
    ...
    { nombre: "Uva Aurora", minutos: 1680, imagen: "uva_aurora.png" },
...
// CORRECCIÓN: Solo manipulamos la alarma de fondo silenciosamente una vez
...
// CORRECCIÓN: El clic suena natural sin que nadie lo interrumpa
            ...
            div.innerHTML = `
                <div style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 2px;">
                        <span id="texto-fecha-${alarma.id}" style="font-size: 1.25rem;">Calculando...</span>
                        <span id="contador-${alarma.id}" style="color: #e68a2e; font-size: 1.35rem; font-weight: bold; text-shadow: 1px 1px 0 #000;">⏳ Calculando...</span>
                    </div>
                </div>
            `;
        }
